...
//								}
			...
			var $metaBoxes				= $('#normal-sortables')
												.children('.postbox:not(#wpb_visual_composer):not(#vcwb_visual_composer):not(#woocommerce-product-data):not(#wc-memberships-product-memberships-data):not(#wpseo_meta):not(#the_grid_item_formats):not(.acf-postbox):not(#custom_content_editor):not(#pagebilder_content)')
												.clone(),
				$advancedContainer		= $('#advanced-sortables');

			$('#normal-sortables').children('.postbox:not(#wpb_visual_composer):not(#vcwb_visual_composer):not(#woocommerce-product-data):not(#wc-memberships-product-memberships-data):not(#wpseo_meta):not(#the_grid_item_formats):not(.acf-postbox):not(#custom_content_editor):not(#pagebilder_content)').remove();
